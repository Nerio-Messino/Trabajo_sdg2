...
#define BSRR5_MASK 0x20 
#define MODER13_AS_INPUT ( GPIO_MODE_IN << 13 * 2)
#define PUPDR13_AS_NOPUPD ( GPIO_PUPDR_NOPULL << 13 * 2)
#define IDR13_MASK (0x01 << 13) 
#define MODER13_MASK (0x03 << 13 * 2)
#define PUDR13_MASK (0x03 << 13 * 2)
#define BIT5_MASK  0x0020
#define MODER5_AS_ALTERNATE 0x0800
#define ALT_FUNC_TIM2 0x01U
#define BASE_ALT_MASK 0x0F
#define AFRL5_MASK ( BASE_ALT_MASK << 4* LINEA_5 )
